...
<body>
    ...
    if (isset($_POST['submit'])) {
        $data = array(
            ...
            'message' => $wpdb->escape($_POST['text']),
        );
    ...
    <div class="bg-gray-800 text-gray-100 px-8 py-12  ">
        ...
        <div class="max-w-screen-xl  px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            ...
            <div class="flex flex-col justify-between">
                <div>
                    <span class=" mb-4 block text-indigo-700 font-semibold">
                        Contact Us
                    </span>
                    <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Lets talk about everything!</h2>
                    <div class="text-gray-700 mt-8">
                        Got a technical issue? Need details about our Business plan? <br> Let us know.
                    </div>
                </div>
            ...
            <form class="form" method="post">
                <div>
                    <label for="fullname" class="uppercase text-sm text-gray-600 font-bold">Full Name</label>
                    <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" name="fullname" id="fullname" required>
                </div>
                <div class="mt-8">
                    <label for="email" class="uppercase text-sm text-gray-600 font-bold">Email</label>
                    <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" name="email" id="email" required>
                </div>

                <div class="mt-8">
                    <label for="text" class="uppercase text-sm text-gray-600 font-bold">Message</span>
                        <textarea name="text" class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" required></textarea>
                </div>
                <div class="mt-8">
                    <button type="submit" name="submit" value="send" class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline hover:bg-white hover:text-indigo-500 border border-indigo-500">
                        Send Message
                    </button>
                </div>
            </form>
        ...
        <div>
            <h2 class="mt-10 text-2xl text-center lg:text-3xl font-bold leading-tight">Find The Best Restaurants Near You!</h2>
        </div>

        <div class="w-full  flex items-center justify-center relative text-right py-8">
            <div class="bg-none overflow-hidden rounded-lg">
                <iframe class="gmap_iframe" width="900" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Prishtina,%20Traditional%20Food%20Restaurant&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
                </iframe>
            </div>
        </div>
