...
if (isset($_POST['edit'])) {
    ...
    $name = $wpdb->escape($_POST['na']);
    $lname = $wpdb->escape($_POST['lna']);
    ...
    if (count($error) == 0) {
        ...
        if ($update == 1) {
            $success = 'Your personal Information Update successfully!';
...
<section class="w-full bg-white">
    <div class="container max-w-screen-xl px-2 py-2 mx-auto lg:py-22 lg:px-6">
        ...
        <div class="py-4 container flex gap-3 items-center">
            ...
            <p class="text-gray-600 font-medium uppercase">Personal Info</p>
        </div>
        <!-- breadcrum end -->
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="na" class="input-box w-full block border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-yellow-900 placeholder-gray-400" value="<?php echo $query->name; ?>">
                            </div>
                            <div>
                                <label class="text-gray-600 mb-2 block">
                                    First Name
                                </label>
                                <input type="text" name="lna" class="input-box w-full block border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-yellow-900 placeholder-gray-400" value="<?php echo $query->surname; ?>">
                            </div>
                            <div>
                                <label class="text-gray-600 mb-2 block">
                                    Email Address
                                </label>
                                <input type="text" name="email" class="input-box w-full block border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-yellow-900 placeholder-gray-400" value="<?php echo $query->email; ?>">
                            </div>
                            <div>
                                <label class="text-gray-600 mb-2 block">
                                    Role
                                </label>
                                <input type="text" class="input-box w-full block border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-yellow-900 placeholder-gray-400" value="<?php echo ucfirst($query->role); ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="mt-6">
